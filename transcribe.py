...
def transcribe_audio(file_path, mode):
...
if __name__ == "__main__":
    ...
    log = f"What is the model you want to run:\n\n{table}\n\nType in the model size you wish to run(ex: base): "
    
    print(log)  
    mode = input()  
    result = transcribe_audio(mp3_file, mode)
    if result != -1:
        organized_transcript = organize_transcript(result)
